...
FireWorks_2::FireWorks_2(ofVec3f Pos,int color_count,int type){
    for(int i = 0; i<30; i++){
        pos_1[i] = Pos;
        pos_2[i] = Pos;
    ...
    for(int i=0; i<30; i++){
        ...
        if (flag ==true) {
            ...
            if(color_count_ == 0){
                ...
                ofSetColor(0, 255, 0,alpha_1);
                
            }else if (color_count_ == 6){
                ofSetColor(125, 0, 255,alpha_1);
                
            }else if (color_count_ == 7){
                ofSetColor(255, 125, 0,alpha_1);
